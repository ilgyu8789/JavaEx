...
public class HashtableEx {
	...
	public static void main(String[] args) {
		//	Hashtable 생성
		Map<String, ClassRoom> map = new Hashtable<>(0);
		
		//	Map에 데이터 넣기: put
		map.put("101", new ClassRoom("Java", "R101"));
		map.put("201", new ClassRoom("C", "R201"));	//	중복이라 적용x
		map.put("301", new ClassRoom("Python", "R301"));
		map.put("201", new ClassRoom("Linux", "R201")); //데이터 변경
		...
		//	값이 있는지?
		System.out.println(map.containsValue("Java"));	//	중복이기때문에 값출력 x
