...
//		SPEED_LIMIT = 160; // 변경 시도 불가 -> 이전 선언에 final을 선언했기때문
	...
	private static void IntegerEx() {
		...
		longVar1 = 2021;
		longVar2 = 1234567890123L; // L or 1
	...
	private static void varEx() {
		...
		// private static void varEx() {
		/*
		 * 변수의식별자 규칙 1. 문자, 숫자, $, _ 사용할 수 있다 2. 숫자로 시작할 수 없다 3. 예약어는 사용할 수 없다 4. 변수,
		 * 메서드의 명명규칙 : camelCase
		 */
		...
		// 자바는 정적 타입 언어
		// 다른 타입의 데이터를 담을 수 없다
		// age = 3.14; -> Error (int는 정수인데 실수를 넣었기때문)
